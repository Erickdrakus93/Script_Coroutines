...
\begin{document}
    ...
    %TODO: Hacer las correcciones de definiciones y demostraciones para que se pueda hacer el resto del capitulo de la tesis.

    \maketitle
    \tableofcontents{}
    %Aqui se cambia el nombre de decidibilidad para que se en un contexto de cualquier Modelo
    % De los que se deba de hacer.
...
\end{theorem}
    ...
    %! TODO: Hacer las correcciones de las definiciones de simulacion %!.
    %! Primero Tendremos las simulación con los modelos de máquinas de Turing y modelos
    %! con terminación en el modelo LOCAL.
    ...
    % Todo: Hacer la correccion de la definicion de modelo.
    % Todo: Y con base a esas correcciones hacer, hacer un check del diseño del algoritmo,
    % Hacer una definicion con las terminaciones en LOCAL con el modelo de computo distribuido.
    % Aquí se hablará unicamente de los modelos de MT y de los modelos distribuidos.
    % Despues hacer las modificaciones de las soluciones de las que se tienen.
    ...
    %Todo:Hacer las modificaciones para que las definiciones de simulacion sean correctas.
    ...
    %Todo: Hacer las correcciones de las definiciones principales de simulacion de modelos.
    %todo: Hacer las correcciones del algoritmo de simulacion.
    % Hace las correcciones de decidibilidad distribuida.
    % Entender la reducibilidad en terminos del modelo de la maquina de turing
