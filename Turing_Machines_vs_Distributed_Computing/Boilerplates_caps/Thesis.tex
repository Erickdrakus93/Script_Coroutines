...
\begin{document}
    ...
    %!Todo Crear la parte de la que se deba de hacer la complejidad temporal
    %!todo:Definir de manera formal lo que es complejidad temporal en este modelo que consume solo cadenas as stdin
